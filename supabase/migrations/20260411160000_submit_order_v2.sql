-- Server-trusted order submission RPC.
-- Resolves prices from catalog_items, validates variants, computes totals.
-- Coexists with legacy create_order_request_with_items.
...
BEGIN
  ...
  LEFT JOIN public.catalog_items c ON c.variant_id = m.vid;
